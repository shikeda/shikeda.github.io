...
The data for the Kanchi-in manuscript of the *Ruiju Myōgishō*, available at [https://github.com/shikeda/krm](https://github.com/shikeda/krm), is as follows. This list includes some files that are currently under preparation for public release.
  ...
  * **krm\_definitions** (deprecated): Previously provided the elements of the **`Definition (Original Glosses)`** of the *Myōgishō*, categorized by type. Following the March 2025 specification change, the data and functionality of `KRM_definitions.tsv` were merged into [krm\_notes](./02-02-notes/#comparison-with-krm_definitionstsv-v1155), which lists the corresponding old and new column names.
