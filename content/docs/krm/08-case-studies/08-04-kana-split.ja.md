...
本稿は、和訓「ツク」を例に、同仮名異語（同じ仮名表記を持つ異なる語）の区別を検証したものである。和訓「ウゴク」「ミル」の調査では『日本国語大辞典　第二版』（日国）表記欄の検証を主としたが、本稿では観点を変え、三巻本『色葉字類抄』（前田本・黒川本、字類抄）を手がかりに名義抄の和訓を検証する。まず国語辞典（日国、角川古語大辞典）を確認すると、「つく」には14〜10、「つぐ」には4〜2の見出し語が立項されており、同音異義が多いことを示す。次に、KRM_wakun.tsvに付与した日国IDにより名義抄の「つく」「つぐ」を分類すると、「付・着・就・即・憑」「突・衝・撞・搗・舂・築・吐」など複数の語群に分かれる一方、日国IDを付与できない例が「つく」60、「つぐ」1あり、整理を要することが分かった。さらに字類抄のツ・辞字を、付（54字）・次（51字）・突（30字）・漬（1字）・告（19字）・舂（8字）、およびヅク（木菟、1字）に分けて一覧化し、佐藤喜代治『色葉字類抄略注』と『字義字訓辞典』の考証をもとに、名義抄での所在・日国表記欄の収録有無を対照した。各語群について、両書での考証の有無、字類抄にあって名義抄にない例、日国表記欄にない例を集計する統一的な観点を設け、たとえば付ツク54字では両書あわせて52字（96％）に考証があることを確認した。両書とも未検討の残余の字（「㧢」「扔」「戀」等）については、『故訓匯纂』『広韻』『万象名義』等を個別に参照して典拠を探った。ヅク（木菟）については、名義抄「巧婦」「𪃪鵒」等6項目の和訓を爾雅・新撰字鏡等により考証し、「兔」の異体字とUnicode対応も整理した。調査は多岐にわたり十分にまとめきれなかったため、本稿はひとまず区切りとして留め置くこととした。
...
ひとまずここで和訓「ツク」を例にした同仮名異語の区別の検証は終えることとする。