---
title: "Headwords, Entry Arrangement, and ID System"
weight: 2
...
# Headwords, Entry Arrangement, and ID System
...
* Kazama Edition Location (`kazama_location` - e.g., K01001310) - K-format
...
The method for indicating the Tenri Edition Location is based on the same principles as that for the Kazama Edition Location. The examples used to explain the Kazama Edition Location, if shown as Tenri Edition Locations, would be as follows:
