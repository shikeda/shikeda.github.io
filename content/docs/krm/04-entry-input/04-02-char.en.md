...
For example, for the **`Headword`** of **`Entry`** ID (`entry_id`) F01852, if its corresponding `kazama_location_id` in the `krm_headword_chars` file is `K01075140`, then its GlyphWiki glyph number will be `hdic_hkrm-01075140`.
