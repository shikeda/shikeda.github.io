---
title: "Entry and Headword Counts by Radical Section"
weight: 19
...
# Entry and Headword Counts by Radical Section

This page tabulates, for each of the *Myōgishō*'s 120 radical sections, the headword and entry counts derived using the method set out in [Calculation of Headword Character Count](../05-02-headword-count/); see that page for the calculation method itself.
