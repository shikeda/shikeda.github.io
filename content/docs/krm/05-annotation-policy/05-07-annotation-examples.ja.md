...
試みに、注釈の例を作成してみた。
ご意見いただければ幸いである。
なお、**K01062610　匜**など、注釈すべきなのに、未記載のところが残っている。
今後、追加修正したい。
...
観智院本の所在は、K01062121のように示す。これは観智院本第1帖62頁1行2段目にある
項目の1文字目にあたることを表している。末尾の1桁は項目内での掲出字の順番を示し、
単独の掲出字からなる項目では0、複数の掲出字からなる項目では1文字目から順に1、2、…となる。
